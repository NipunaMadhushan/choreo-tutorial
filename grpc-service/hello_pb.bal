...
public const string HELLO_DESC = "";
...
public isolated client class HelloWorldClient {
    *grpc:AbstractClientEndpoint;
    ...
    public isolated function init(string url, *grpc:ClientConfiguration config) returns grpc:Error? {
        ...
        check self.grpcClient.initStub(self, HELLO_DESC);
    }
    ...
    isolated remote function hello(HelloRequest|ContextHelloRequest req) returns HelloResponse|grpc:Error {
        ...
        var payload = check self.grpcClient->executeSimpleRPC("hello.HelloWorld/hello", message, headers);
...
@protobuf:Descriptor {value: HELLO_DESC}
